...
function Register() {
    ...
    const handleChange = (e_0)=>{
        ...
        if (errors[e_0.target.name]) setErrors({
            ...errors,
            [e_0.target.name]: ''
        });
    };
...
/** Reusable Input Field Component */ function InputField(t0) {
    ...
    if ($[0] !== "50f301b2caaf3959f419cbe029a07ccd21df40e6d53fb81b606913bab14c94e3") {
        for(let $i = 0; $i < 17; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "50f301b2caaf3959f419cbe029a07ccd21df40e6d53fb81b606913bab14c94e3";
    }
